...
## 当前待办
- 已完成本轮代码修复、静态校验与真实 PDF 样本验证，待提交、推送后做线上强刷回归复测
...
- ✅ 已将版本信息提升为：`utils.js v4`、`ocr.js v33`、`calendar.js v24`、`app.js v86`、部署版本 `P3-5`
- ✅ 已完成 `node --check js/ocr.js`
- ✅ 已完成 `node --check js/utils.js`
