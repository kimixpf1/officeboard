...
class OfficeDashboard {
    ...
    updateDeployVersionBadge() {
        ...
        const version = '2026-05-10 v5.61';
        const scriptVersions = ['utils.js?v=5', 'ocr.js?v=51', 'upload-flow.js?v=9', 'calendar.js?v=41', 'sync.js?v=67', 'app-date-view.js?v=13', 'countdown.js?v=1', 'links.js?v=1', 'contacts.js?v=1', 'app.js?v=197', 'db.js?v=29', 'style.css?v=66', 'crypto.js?v=17'];
