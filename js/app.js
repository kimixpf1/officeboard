...
class OfficeDashboard {
    ...
    updateDeployVersionBadge() {
        ...
        const version = '2026-04-29 v4.63';
        const scriptVersions = ['utils.js?v=4', 'ocr.js?v=35', 'upload-flow.js?v=6', 'calendar.js?v=28', 'sync.js?v=43', 'app-date-view.js?v=10', 'app.js?v=143', 'db.js?v=25', 'style.css?v=53', 'crypto.js?v=16'];
