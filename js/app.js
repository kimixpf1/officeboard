...
class OfficeDashboard {
    ...
    updateDeployVersionBadge() {
        ...
        const version = '2026-05-06 v5.41';
        const scriptVersions = ['utils.js?v=4', 'ocr.js?v=44', 'upload-flow.js?v=9', 'calendar.js?v=38', 'sync.js?v=67', 'app-date-view.js?v=13', 'app.js?v=186', 'db.js?v=28', 'style.css?v=65', 'crypto.js?v=17'];
