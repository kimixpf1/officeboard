...
class OfficeDashboard {
    ...
    updateDeployVersionBadge() {
        ...
        const version = '2026-04-23 P3-29';
        const scriptVersions = ['utils.js?v=4', 'ocr.js?v=35', 'upload-flow.js?v=6', 'calendar.js?v=25', 'sync.js?v=25', 'app-date-view.js?v=7', 'app.js?v=109', 'style.css?v=44'];
