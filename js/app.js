...
class OfficeDashboard {
    ...
    updateDeployVersionBadge() {
        ...
        const version = '2026-04-25 P3-34';
        const scriptVersions = ['utils.js?v=4', 'ocr.js?v=35', 'upload-flow.js?v=6', 'calendar.js?v=27', 'sync.js?v=26', 'app-date-view.js?v=8', 'app.js?v=113', 'style.css?v=48'];
