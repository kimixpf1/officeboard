...
class OfficeDashboard {
    ...
    updateDeployVersionBadge() {
        ...
        const version = '2026-05-01 v5.8';
        const scriptVersions = ['utils.js?v=4', 'ocr.js?v=36', 'upload-flow.js?v=6', 'calendar.js?v=36', 'sync.js?v=52', 'app-date-view.js?v=10', 'app.js?v=158', 'db.js?v=26', 'style.css?v=59', 'crypto.js?v=17'];
