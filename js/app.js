...
class OfficeDashboard {
    ...
    updateDeployVersionBadge() {
        ...
        const version = '2026-05-09 v5.47';
        const scriptVersions = ['utils.js?v=5', 'ocr.js?v=46', 'upload-flow.js?v=9', 'calendar.js?v=39', 'sync.js?v=67', 'app-date-view.js?v=13', 'app.js?v=189', 'db.js?v=29', 'style.css?v=64', 'crypto.js?v=17'];
